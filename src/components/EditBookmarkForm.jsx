      ...
      >
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <textarea
              placeholder="Notes, identifiants..."
              rows={3}
          ...
          <div className="flex items-center justify-between p-4 bg-slate-50 rounded-2xl border border-slate-100">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-bold text-slate-900">Lien privé</p>
                <p className="text-[10px] text-slate-500 font-medium">Masqué lors du partage</p>
              </div>
            </div>
            <button
              type="button"
          ...
          <div className="flex gap-4">
            ...
            <button 
              type="submit"
              className="flex-[2] py-4 bg-blue-600 text-white rounded-xl font-black text-[13px] uppercase tracking-widest hover:bg-blue-700 hover:shadow-lg hover:shadow-blue-600/30 transition-all active:scale-[0.98]"
            >
              Mettre à jour
            </button>
          </div>
